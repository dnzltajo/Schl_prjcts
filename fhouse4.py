...
y12=np.array([9,9,11,9,21,11,9,8,7,6,9,6, 7,5,6,7,6,5,7,5,4,4,3,5])
y1=np.array([9,9,11,9,21,11,9,8,7,6,9,6])
y2=np.array([7,5,6,7,6,5,7,5,4,4,3,5])
y3=np.array([4,4,7,11,8,10,7,8,6,8,7,9])
y4=np.array([9,7,7,6,11,10])
y123=np.array([9,9,11,9,21,11,9,8,7,6,9,6,7,5,6,7,6,5,7,5,4,4,3,5,4,4,7,11,8,10,7,8,6,8,7,9])
...
plt.title('Household 4',loc='center')
plt.subplot(3,2,2)
