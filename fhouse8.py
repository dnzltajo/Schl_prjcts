...
y12=np.array([52,58,52,44,48,46,45,57,95,120,90,60, 86,120,20,61,66,51,48,50,75,86,28,48])
y1=np.array([52,58,52,44,48,46,45,57,95,120,90,60])
y2=np.array([86,120,20,61,66,51,48,50,75,86,28,48])
y3=np.array([64,61,64,35,54,50,58,76,75,78,65,42])
y4=np.array([46,52,53,43,62,38])
y123=np.array([52,58,52,44,48,46,45,57,95,120,90,60,86,120,20,61,66,51,48,50,75,86,28,48,64,61,64,35,54,50,58,76,75,78,65,42])
...
plt.title('Household 8',loc='center')
plt.subplot(3,2,2)
