...
y12=np.array([23,0,14,19,14,28,23,28,26,12,21,19, 18,19,20,19,19,16,18,17,13,20,14,14])
y1=np.array([23,0,14,19,14,28,23,28,26,12,21,19])
y2=np.array([18,19,20,19,19,16,18,17,13,20,14,14])
y3=np.array([10,22,42,21,20,11,8,7,7,12,8,9])
y4=np.array([9,9,7,5,13,10])
y123=np.array([23,0,14,19,14,28,23,28,26,12,21,19,18,19,20,19,19,16,18,17,13,20,14,14,10,22,42,21,20,11,8,7,7,12,8,9])
...
plt.title('Household 5',loc='center')
plt.subplot(3,2,2)
