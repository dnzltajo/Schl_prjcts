...
x3=np.arange(25,37)
x4=np.arange(37,43)
y1=np.array([15,19,15,22,35,31,27,25,32,21,11,5])
y2=np.array([7,18,17,23,20,22,19,17,19,22,23,19])
y3=np.array([24,14,15,19,23,20,16,19,17,21,15,12])
y4=np.array([14,11,12,15,21,19])
y12=np.array([15,19,15,22,35,31,27,25,32,21,11,5, 7,18,17,23,20,22,19,17,19,22,23,19])
y123=np.array([15,19,15,22,35,31,27,25,32,21,11,5, 7,18,17,23,20,22,19,17,19,22,23,19, 24,14,15,19,23,20,16,19,17,21,15,12])
...
plt.title('Household 1',loc='center')
plt.subplot(3,2,2)
