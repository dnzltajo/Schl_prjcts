...
y12=np.array([64,58,58,46,66,60,52,94,110,112,86,80, 87,76,72,55,80,67,73,88,116,94,54,84])
y1=np.array([64,58,58,46,66,60,52,94,110,112,86,80])
y2=np.array([87,76,72,55,80,67,73,88,116,94,54,84])
y3=np.array([98,102,100,78,75,90,66,76,97,95,86,96])
y4=np.array([93,91,77,83,78,76])
y123=np.array([64,58,58,46,66,60,52,94,110,112,86,80,87,76,72,55,80,67,73,88,116,94,54,84,98,102,100,78,75,90,66,76,97,95,86,96])
...
plt.title('Household 7',loc='center')
plt.subplot(3,2,2)
