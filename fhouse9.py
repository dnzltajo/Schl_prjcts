...
y12=np.array([248,238,263,218,220,206,182,204,214,217,183,220, 189,188,186,209,209,209,212,249,253,222,128,209])
y1=np.array([248,238,263,218,220,206,182,204,214,217,183,220])
y2=np.array([189,188,186,209,209,209,212,249,253,222,128,209])
y3=np.array([191,221,198,193,226,197,196,286,258,233,222,202])
y4=np.array([220,237,266,297,170,169])
y123=np.array([248,238,263,218,220,206,182,204,214,217,183,220,189,188,186,209,209,209,212,249,253,222,128,209,191,221,198,193,226,197,196,286,258,233,222,202])
...
plt.title('Household 9',loc='center')
plt.subplot(3,2,2)
